...
export class shipmentService {
    ...
    async shipmentlist(req, res) {
        try {
            ...
            shipmentData.forEach(async (element, index) => {
                ...
                // To replace currency name to currency symbol
    ...
    async shipmentDetail(req, res){
        try {
            ...
            console.log("shipmentData.packageWidth ", shipmentData.packageWidth );
            console.log("packageDimension.height", packageDimension.height);
